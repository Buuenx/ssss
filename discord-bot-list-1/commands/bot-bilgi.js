...
module.exports = {
	...
	run: (client, message, args) => {
	 ...
	 const duration = moment.duration(client.uptime).format('M [Ay],  W [Hafta], D[Gün], H [Saat], m [Dakika]');    
	    ...
	    .addField(`Bağlantılar`, ` [[Davet Et]](${inviteUrl}) | [[Destek Sunucusu]](https://discord.gg/bsh8vUYrwn)`)
        .setFooter(client.user.username, client.user.avatarURL())
		.setDescription("BU BOT GLOBAL DEĞİL BX SUNUCUSUNA ÖZELDİR ANCAK The BX Bot u Sunucuna Ekleyerek Bana Katkıda Bulunabilirsin.")
